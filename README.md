...
An *always* relative time-ago-in-words description can be generated by using the `relative-time-ago` element extension.

``` html
<time is="relative-time-ago" datetime="2012-04-01T16:30:00-08:00">
  04/01/12
</time>
<!-- <time is="relative-time-ago">2 years ago</time> -->
```
